<script lang="ts">
    import type {BoundingBox, Field, FieldGeneric} from "@coin/resonitelink-ts"
    const { data, changeField }: { data: FieldGeneric<string, BoundingBox>, changeField: (data: Field) => void } = $props()
